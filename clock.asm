...
reset:
  ...
  lda r0                 ; Load events
  and #EVENT_TICK        ; Keep tick event
  beq .end_tick          ; No tick event
  jsr lcd_blink_tick     ; Call tick event handler
  .end_tick:
